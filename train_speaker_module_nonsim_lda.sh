    ...
    do
        ...
        do
            ...
            do
                ...
                speaker_latent=100
                acoustic_latent=100
                experiment_name=nonsim.${activation}.speaker-${speaker_latent}.acoustic-${acoustic_latent}.method-${method}.batch_size-${batch_size}.learning_rate-${learning_rate}.gradient_clip-${gradient_clip}.nanfilter
