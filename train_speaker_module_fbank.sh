        ...
        do
            ...
            do
                ...
                model_params="--left-context $context --right-context $context \
                    ...
                    --speaker-structure  1024:$speaker_latent \
                    --acoustic-structure 1024:$acoustic_latent \
                ...
                export THEANO_FLAGS=device=cuda #,optimizer=fast_compile
                #python -u $TK_DIR/test_utterance_vae_shared.py \
