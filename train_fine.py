...
if __name__ == "__main__":
	...
	for layer_idx in xrange(len(output_layers)):
		loss = cross_entropy = T.mean(T.nnet.categorical_crossentropy(output_layers[layer_idx],Y))
		parameters = [ params["W_output_%d"%layer_idx], params["b_output_%d"%layer_idx] ]
